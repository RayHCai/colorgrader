    ...
    return (
        <div className="forum-details-modal">
            <div className="forum-details-modal-container">
                <button className="styled-button-colored" onClick={ props.close }>
                    X
                </button>
                ...
                { !filterSimilarity ? (
                    <button
                        className="styled-button-colored similarity-button"
                    ...
                    <input
                        onChange={ (e: React.ChangeEvent<HTMLInputElement>) =>
                            updateSimilarity(e.target.value as any)
                        }
                        step="0.01"
                        type="number"
                        placeholder="Base Similarity"
                        min="0.0"
                        max="1.0"
                    />
                ) }
                ...
                <button
                    ...
                    onClick={ () => props.filter(filterSimilarity, similarity) }
                >
                    Filter
                </button>
            </div>
